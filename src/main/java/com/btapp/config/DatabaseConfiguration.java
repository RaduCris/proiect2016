...
import com.btapp.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.btapp.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.btapp.repository.search")
