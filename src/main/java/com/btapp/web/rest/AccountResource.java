...
import com.btapp.domain.PersistentToken;
import com.btapp.domain.User;
import com.btapp.repository.PersistentTokenRepository;
import com.btapp.repository.UserRepository;
import com.btapp.security.SecurityUtils;
import com.btapp.service.MailService;
import com.btapp.service.UserService;
import com.btapp.web.rest.dto.KeyAndPasswordDTO;
        ...
        return userRepository.findOneByLogin(userDTO.getLogin())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(userDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    userDTO.getLangKey(), userDTO.getIdManager()); // modificat 11.03.2016
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getIdManager());
