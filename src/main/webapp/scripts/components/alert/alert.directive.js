        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('btravelappApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-btravelappApp-error');
                                var entityKey = httpResponse.headers('X-btravelappApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('btravelappApp.' + fieldError.objectName + '.' + convertedField);
